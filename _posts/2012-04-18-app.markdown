...
<div>
    <p>
        Перевіримо, чи ми в пустій папці, запустивши знову команду <code>ls</code>. Тепер створимо новий застосунок з назвою <code>railsteens</code>, запустивши команду:
    </p>
</div>
...
<div>
    <p>
        Перевіремо, чи ми в пустій папці, запустивши знову команду <code>dir</code>. Тепер створимо новий застосунок з назвою <code>railsteens</code>, запустивши команду:
    </p>
</div>
